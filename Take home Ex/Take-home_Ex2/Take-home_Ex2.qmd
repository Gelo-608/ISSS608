...
fig <- plot_ly(
  ...
  text = ~paste0(
    Commodity, 
    "<br>值: ", formatC(Total_Value, format="f", big.mark=",", digits=0), 
    "<br>占比: ", round(Total_Value/sum(Total_Value)*100, 1), "%"
  )
)
