...
1.  Master Plan 2014 Subzone Boundary (Web) (i.e. `MP14_SUBZONE_WEB_PL`) in ESRI shapefile format. It can be downloaded at [data.gov.sg](https://data.gov.sg/) This is a geospatial data. 
...
\
mutate(`DEPENDENCY` = (`YOUNG` + `AGED`) /`ECONOMY ACTIVE`) %\>% select(`PA`, `SZ`, `YOUNG`, `ECONOMY ACTIVE`, `AGED`, `TOTAL`, `DEPENDENCY`)
...
tm_shape(mpsz_pop2020)+
  tm_fill("DEPENDENCY",
          fill.scale = tm_scale_intervals(n = 5, style = "equal"),
          fill.palette = "brewer.yl_or_rd") +
  tm_borders(fill_alpha = 0.5)

tm_shape(mpsz_pop2020)+
  tm_fill("DEPENDENCY",
          fill.scale = tm_scale_intervals(n = 5, style = "fisher"),
          fill.palette = "brewer.yl_or_rd") +
  tm_borders(fill_alpha = 0.5)

tm_shape(mpsz_pop2020)+
  tm_fill("DEPENDENCY",
          fill.scale = tm_scale_intervals(n = 5, style = "kmeans"),
          fill.palette = "brewer.yl_or_rd") +
  tm_borders(fill_alpha = 0.5)
...
```{r}
for (n_classes in c(2, 6, 10, 20)) {
  print(
    tm_shape(mpsz_pop2020) +
      tm_polygons("DEPENDENCY", 
                  fill.scale = tm_scale_intervals(n = n_classes, style = "quantile"),  
                  fill.palette = "brewer.yl_or_rd") +  
      tm_borders(fill_alpha = 0.5) +
      tm_title(paste("Quantile Classification -", n_classes, "Classes"))
  )
}
```
...
#### 5.3.1 By assigning multiple values to at least one of the aesthetic arguments
...
#### 5.3.2 By defining a group-by variable in *tm_facets()*
...
#### 5.3.3 By creating multiple stand-alone maps with *tmap_arrange()*
...
### **5.4 Mappping Spatial Object Meeting a Selection Criterion**
